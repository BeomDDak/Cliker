...
public class RunElecto : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mouseCountTxt.text = "수량 : 0 개";
        headsetCountTxt.text = "수량 : 0 개";
        nintendoCountTxt.text = "수량 : 0 개";
        graphicCountTxt.text = "수량 : 0 개";
    }
    ...
    void Update()
    {
        ...
        if (startpanel.activeSelf == false && liePanel.activeSelf == false)
        {
            ...
            mouseCountTxt.text = "수량 : " + mouseCount.ToString();
            headsetCountTxt.text = "수량 : " + headsetCount.ToString();
            nintendoCountTxt.text = "수량 : " + nintendoCount.ToString();
            graphicCountTxt.text = "수량 : " + graphicCount.ToString();
